...
>(
  input: AcceptAdminAsyncInput<TAccountNewAdmin, TAccountRoutingConfig>,
...
export function getAcceptAdminInstruction<
  ...
  TProgramAddress extends Address = typeof HOPPER_PROGRAM_ADDRESS,
>(
  input: AcceptAdminInput<TAccountNewAdmin, TAccountRoutingConfig>,
  config?: { programAddress?: TProgramAddress }
): AcceptAdminInstruction<
  TProgramAddress,
  TAccountNewAdmin,
...
>(
  ...
  return {
    ...
    accounts: { newAdmin: getNextAccount(), routingConfig: getNextAccount() },
